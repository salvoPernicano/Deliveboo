...
return [
    ...
    */
    ...
    'ascii' => 'Il campo :attribute può contenere solo caratteri alfanumerici e simboli di un byte.',
    ...
    |--------------------------------------------------------------------------
    |
    | Qui è possibile specificare messaggi di validazione personalizzati per attributi utilizzando il
    | convenzione "attribute.rule" per nominare le linee. Questo ci permette di velocizzare
    | la specifica di un messaggio di lingua personalizzato specifico per una determinata regola dell'attributo.
    |
    */
