<template>
  <AuthenticatedLayout>
    <div class="flex flex-col gap-9 justify-center items-center">
      ...
      <form class="flex flex-col text-black text-lg text-center gap-7" @submit.prevent="submit(restaurant.id)"
        ...
        <button type="submit"
          class="bg-blue-950 hover:bg-black hover:text-white text-black font-bold py-2 px-4 rounded-full uppercase">Salva
          piatto</button>
      </form>
    </div>
  </AuthenticatedLayout>
