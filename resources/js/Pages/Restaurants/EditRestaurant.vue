...
const props = defineProps({ errors:Object,restaurant:Object });
...
const editRestaurant = useForm({
 ...
 function submit(id){
    router.put('/restaurant/'+id,editRestaurant)
 }
...
<template>
    <AuthenticatedLayout>
        ...
        <form class="flex flex-col text-black text-lg text-center gap-7" action="" @submit.prevent="submit(restaurant.id)" enctype="multipart/form-data">
