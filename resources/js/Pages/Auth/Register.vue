...
<template>
        ...
        <div class="flex flex-col  gap-9 justify-center items-center">
            ...
            <form class="bg-orange-400 w-2/3 max-w-3xl p-5 mb-10 rounded-lg flex flex-col  text-black text-lg text-center gap-7" @submit.prevent="handleSubmit" enctype="multipart/form-data">
                ...
                <div class="flex items-center justify-center mx-auto w-4/5 s gap-4">
                    <div class="w-full">
                        ...
                        <input id="name" type="text" class="mt-1 block w-full rounded-lg" v-model="registrationForm.name" required autofocus autocomplete="name">
                        <InputError class="mt-2" :message="registrationForm.errors.name" />
                    </div>
                    <div class="w-full">
                        <label class="font-bold" for="email">Email *</label>
                        <input id="email" type="email" class="mt-1 block w-full rounded-lg" v-model="registrationForm.email" required autocomplete="username">
                ...
                <div class="flex items-center justify-center mx-auto w-4/5 s gap-4">
                    <div class="w-full">
                        ...
                        <input id="password" type="password" class="mt-1 block w-full rounded-lg" v-model="registrationForm.password" required autocomplete="new-password">
                    ...
                    <div class="w-full">
                        ...
                        <input id="password_confirmation" type="password" class="mt-1 block w-full rounded-lg" v-model="registrationForm.password_confirmation" required autocomplete="new-password">
                ...
                <div class="flex flex-col w-4/5 mx-auto">
                    ...
                    <input id="restaurantName" class="text-black rounded-md" type="text" name="name" v-model="registrationForm.restaurant_name" required>
                ...
                <div class="flex flex-col w-4/5 mx-auto">
                    ...
                    <input id="restaurantAddress" class="text-black rounded-md" type="text" name="address" v-model="registrationForm.address" required>
                ...
                <div class="flex flex-col w-4/5 mx-auto">
                    ...
                    <input id="restaurantPIVA" class="text-black rounded-md" type="text" name="p_iva" v-model="registrationForm.p_iva" required>
                ...
                <div class="flex flex-col w-4/5 bg-white rounded-lg p-2 border border-gray-500  mx-auto">
                    ...
                    <input id="restaurantImage" class="mx-auto" type="file" name="image" accept="image/*" @change="handleImageChange">
                ...
                <div class="flex flex-col  w-4/5 mx-auto">
                    ...
                    <textarea id="restaurantDescription" class="text-black rounded-lg" name="description" cols="30" rows="3" v-model="registrationForm.description"></textarea>
                    <div v-if="errors.description"><span class="text-red-700">{{ errors.description }}</span></div>
                </div>

                <div class="flex flex-col  mx-auto">
                    <label class="font-bold" for="restaurantTypologies">Seleziona le tipologie di cucina del ristorante</label>
                    <select id="restaurantTypologies" class="rounded-lg" v-model="registrationForm.selectedTypologies" multiple>
                ...
                <div class="flex items-center justify-center gap-5 mt-4">
                    <button type="submit" class="bg-white hover:bg-black hover:text-white text-black font-bold py-2 px-4 rounded-full uppercase">registati</button>
                </div>
